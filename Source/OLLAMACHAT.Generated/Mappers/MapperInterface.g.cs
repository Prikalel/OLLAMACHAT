namespace OLLAMACHAT.Generated.Mappers
{
    public partial class MapperInterface : OLLAMACHAT.Generated.Mappers.IMapperInterface
    {
        ...
        private System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.RelationshipDto> funcMain11(System.Collections.Generic.List<VelikiyPrikalel.OLLAMACHAT.Application.Models.Relationship> p13)
        {
            if (p13 == null)
            {
                return null;
            }
            System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.RelationshipDto> result = new System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.RelationshipDto>(p13.Count);
        ...
        private OLLAMACHAT.Generated.Models.ParseResponse.ParsedEntityDto funcMain2(VelikiyPrikalel.OLLAMACHAT.Application.Models.ParsedEntity p4)
        {
            return p4 == null ? null : new OLLAMACHAT.Generated.Models.ParseResponse.ParsedEntityDto()
            {
                ...
                ImportData = p4.ImportData == null ? null : new OLLAMACHAT.Generated.Models.ParseResponse.ParsedEntityImportDataDto() {Source = p4.ImportData.Source}
            };
        }
        ...
        private System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.DecoratorDto> funcMain4(System.Collections.Generic.List<VelikiyPrikalel.OLLAMACHAT.Application.Models.Decorator> p6)
        {
            if (p6 == null)
            {
                return null;
            }
            System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.DecoratorDto> result = new System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.DecoratorDto>(p6.Count);
        ...
        private OLLAMACHAT.Generated.Models.ParseResponse.ParsedEntityInheritanceDto funcMain7(VelikiyPrikalel.OLLAMACHAT.Application.Models.ParsedEntityInheritance p9)
        {
            return p9 == null ? null : new OLLAMACHAT.Generated.Models.ParseResponse.ParsedEntityInheritanceDto()
            {
        ...
        private System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.ModelParameterDto> funcMain10(System.Collections.Generic.List<VelikiyPrikalel.OLLAMACHAT.Application.Models.ModelParameter> p12)
        {
            if (p12 == null)
            {
                return null;
            }
            System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.ModelParameterDto> result = new System.Collections.Generic.List<OLLAMACHAT.Generated.Models.ParseResponse.ModelParameterDto>(p12.Count);
        ...
        private OLLAMACHAT.Generated.Models.ParseResponse.DecoratorDto funcMain5(VelikiyPrikalel.OLLAMACHAT.Application.Models.Decorator p7)
        {
            return p7 == null ? null : new OLLAMACHAT.Generated.Models.ParseResponse.DecoratorDto()
            {
                Name = p7.Name,
